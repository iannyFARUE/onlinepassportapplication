...
<div class="container">
    <div class="card mt-5 p-2" id="">
        ...
        <div class="row bg-gradient-primary my-2">
            ...
            <div class="col-md-4">
                <h5 class="details text-danger"><b>Address</b></h5>   <span class="text-default">{{$nationalID->address}}</span>

            </div>
            <div class="col-md-4">
                <h5 class="details text-danger"><b>Status</b></h5>   <span class="text-default">{{$nationalID->statuses->status ?? 'N/A'}}</span>
